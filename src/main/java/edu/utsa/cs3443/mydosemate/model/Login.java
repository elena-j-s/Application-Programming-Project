...
public class Login {
     ...
     *
     * It will search data/ for a user.csv file to parse
     * It will then search user.csv for a match and if found will return
     * the path to users/user_id/ directory associated with the user found
     */
    public Path authenticateUser (String username, String password) throws IOException {
    ...
    *
    * Will check if the user already exists within data/user.csv
